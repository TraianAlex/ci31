...
table th.tg-sort-header:hover:after {  visibility:visible;  }table th.tg-sort-desc:after,table th.tg-sort-asc:after,table th.tg-sort-asc:hover:after {  visibility:visible;  opacity:0.4;  }
table th.tg-sort-desc:after {  border-bottom:none;  border-width:4px 4px 0;  }@media screen and (max-width: 767px) {.tg {width: auto !important;}
...
#pagination strong, #pagination a:hover{font-weight: normal;background: #e8edff;}
</style>
    ...
    <div class="col-xs-6 col-md-4">
      <div class="tg-wrap">
        ...
        <table id="tg-gnYkL" class="tg">
          ...
          <tr>
            <td class="tg-yw4l"><?=$film->film_id?></td>
            <td class="tg-yw4l"><?=$film->title?></td>
            <td class="tg-yw4l"><?=$film->release_year?></td>
            <td class="tg-yw4l"><?=$film->length?></td>
            <td class="tg-yw4l"><?=$film->replacement_cost?></td>
            <td class="tg-yw4l"><?=$film->rating?></td>
          </tr>
          <?php endforeach;?>
        </table>
